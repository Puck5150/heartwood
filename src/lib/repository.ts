// Thin storage layer: the only module allowed to talk to the SQL plugin.
// All the meaningful logic (shape conversion, recovery decisions) lives in
// persistence.ts, which is pure and unit-tested; this file is intentionally
// dumb — load a connection, run a query, done.
